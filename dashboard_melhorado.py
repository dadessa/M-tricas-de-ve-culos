# -*- coding: utf-8 -*-
"""
Métricas de Veículos (v4.2-fix)
- Correção de erro: 'unterminated string literal' causado por quebra de linha dentro de string
- Arquivo reformatado para evitar wraps acidentais em Output(...,"columns")
- Leitura robusta (Sheets CSV/Excel), normalização de colunas, persistência de valores e exports
"""
...
THEME_COLORS = {
    "light": {
        "font": "#0F172A", "muted": "#64748B", "grid": "#E9EDF5", "paper": "rgba(0,0,0,0)", "plot": "rgba(0,0,0,0)",
        "colorway": ["#3B82F6", "#22C55E", "#F59E0B", "#EF4444", "#06B6D4", "#A78BFA"], "template": "plotly_white",
    },
    "dark": {
        "font": "#E6ECFF", "muted": "#93A3BE", "grid": "#22304A", "paper": "rgba(0,0,0,0)", "plot": "rgba(0,0,0,0)",
...
app.layout = html.Div(className="light", id="root", children=[
    ...
    html.Div(className="container", children=[
        html.Div(className="navbar", children=[
            html.Div(className="brand", children=[html.Div("📊", style={"fontSize": "20px"}), html.H1("Métricas de Veículos"), html.Span("v4.2-fix", className="badge")]),
